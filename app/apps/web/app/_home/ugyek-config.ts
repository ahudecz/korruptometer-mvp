...
export type BreakingUpdateCompanyRow = {
  ...
  received: string;
  profit: string;
  /** Árbevétel-növekedés szorzója a beszerzés előtti évhez képest, ha a
   *  forrás cégenkénti bontásban közli — pl. "165×" (a mögöttes Ft-
   *  összegek a note mezőben vagy a szöveges összefoglalóban élnek). */
...
Kerényi György, a Klub Rádió újságírója 2020-ban már részletesen megírta a botrány főbb vonásait — sem az ügyészség, sem a rendőrség nem reagált. A tényleges nyomozás 6 évvel később, 2026-ban indult el.`,
...

  {
    ...
    breakingUpdate: {
      ...
      companies: [
        { name: 'TMT Technics Kft.', purchasePrice: '24,4 M EUR (1208 gép)', received: '35,5 M EUR', profit: '11 M EUR (~4 Mrd Ft)', revenueGrowth: '165×-ös növekedés', note: '864 M Ft osztalékelőleg; kényszertörlés alatt' },
        { name: 'Pro Concept Tanácsadó Kft.', purchasePrice: '32 M EUR', received: '49 M EUR', profit: '17 M EUR (~6,2 Mrd Ft)', revenueGrowth: '9×-es növekedés', note: '2021-re vissza 3,8 Mrd Ft-ra' },
        { name: 'OTT-ONE Nyrt.', purchasePrice: '13 M USD (500 gép)', received: '14,5 M USD', profit: '1,5 M USD (~506 M Ft)', revenueGrowth: '4×-es növekedés', note: '2021-ben is 6 Mrd Ft' },
        { name: 'Gyömrői-sarok Projekt Szolgáltató Kft.', purchasePrice: '25,1 M USD', received: '27,7 M USD', profit: '2,6 M USD (~876 M Ft)', revenueGrowth: '84×-es növekedés', note: '~1 Mrd Ft osztalék; 2021-re vissza 170 M Ft-ra' },
        { name: 'Speciál 99 Külkereskedelmi Kft.', purchasePrice: '186 ezer USD (30 ezer gyorsteszt)', received: '570 ezer USD', profit: '384 ezer USD (~130 M Ft)', revenueGrowth: '2,5×-es növekedés', note: 'koronavírus-gyorsteszt, nem lélegeztetőgép' },
        { name: 'MAROSPORT Kereskedelmi Kft.', purchasePrice: '12,1 M USD', received: '17,6 M USD', profit: '5,5 M USD (~1,8 Mrd Ft)', revenueGrowth: '217×-es növekedés', note: '2021-ben is 43 Mrd Ft' },
      ],
