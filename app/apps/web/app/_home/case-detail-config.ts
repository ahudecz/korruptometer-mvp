...
export const PERSON_PHOTOS: Record<string, { photoUrl: string; photoCredit?: string; photoObjectPosition?: string }> = {
  'Lezsák Sándor':   { photoUrl: '/images/persons/lezsak-sandor-ahang.webp',                               photoCredit: 'Eredeti fotó: ahang.hu' },
  'Leisztinger Tamás': { photoUrl: '/images/persons/leisztinger_tamas-nemzetisport.hu.webp',               photoCredit: 'Eredeti fotó: nemzetisport.hu' },
  'Kocsis Máté':     { photoUrl: '/images/persons/kocsis_mate_ahang.webp',                                 photoCredit: 'Eredeti fotó: ahang.hu' },
  'Matolcsy Ádám':   { photoUrl: '/images/persons/matolcsy-adam-hvg.webp',                                 photoCredit: 'Eredeti fotó: hvg.hu' },
  'Gattyán György':  { photoUrl: '/images/persons/gattyan_gyorgy_24.hu.webp',                              photoCredit: 'Eredeti fotó: 24.hu' },
  'Kósa Lajos':      { photoUrl: '/images/persons/kosa_lajos_mfor.hu.webp',                                photoCredit: 'Eredeti fotó: mfor.hu' },
  'Orbán Balázs':    { photoUrl: '/images/persons/orban_balazs_orban-balazs-facebook-oldala.webp',         photoCredit: 'Eredeti fotó: Orbán Balázs Facebook oldala', photoObjectPosition: 'center 20%' },
  'Tarsoly Csaba':   { photoUrl: '/images/persons/tarsoly_csaba-ahang.webp',                               photoCredit: 'Eredeti fotó: ahang.hu' },
  'Homlok Zsolt':    { photoUrl: '/images/persons/homlok-zsolt-savariaforum.hu.webp',                      photoCredit: 'Eredeti fotó: savariaforum.hu' },
  'Emőri Gábor':     { photoUrl: '/images/persons/emori_gabor_marketingfesztival.hu.webp',                 photoCredit: 'Eredeti fotó: marketingfesztival.hu' },
  'Palkovics László': { photoUrl: '/images/persons/palkovics_laszlo_ludovikafesztival.uni-nke.hu.webp',    photoCredit: 'Eredeti fotó: uni-nke.hu' },
  'Balázs Attila':   { photoUrl: '/images/persons/balazs_attila_hvg.webp',                                 photoCredit: 'Eredeti fotó: hvg.hu' },
  'Sára Botond':     { photoUrl: '/images/persons/sara-botond-pecsma.hu.webp',                             photoCredit: 'Eredeti fotó: pecsma.hu' },
  'Hernádi Zsolt':   { photoUrl: '/images/persons/hernadi-zsolt-molgroup.info.webp',                       photoCredit: 'Eredeti fotó: molgroup.info' },
  'Tarlós István':   { photoUrl: '/images/persons/tarlos_istvan_hirado.hu.webp',                           photoCredit: 'Eredeti fotó: hirado.hu' },
  'Lantos Csaba':    { photoUrl: '/images/persons/lantos_csaba_24.hu.webp',                                photoCredit: 'Eredeti fotó: 24.hu' },
  'Habony Árpád':    { photoUrl: '/images/persons/habony-arpad_marketingfesztival.hu.webp',                photoCredit: 'Eredeti fotó: marketingfesztival.hu' },
  'Nagy Márton':     { photoUrl: '/images/persons/nagy_marton-wikipedia.webp',                             photoCredit: 'Eredeti fotó: Wikipédia' },
  'Horváth Csaba':   { photoUrl: '/images/persons/horvath-csaba-onkormanyzati.tv.webp',                    photoCredit: 'Eredeti fotó: onkormanyzati.tv' },
  'Szíjj László':    { photoUrl: '/images/persons/szijj-laszlo-ahang.webp',                                photoCredit: 'Eredeti fotó: ahang.hu' },
  'Bige László':     { photoUrl: '/images/persons/bige-laszlo-444.webp',                                   photoCredit: 'Eredeti fotó: 444.hu' },
  'Jászai Gellért':  { photoUrl: '/images/persons/jaszai-gellert-ahang.webp',                              photoCredit: 'Eredeti fotó: ahang.hu' },
  'Csányi Sándor':   { photoUrl: '/images/persons/csanyi-sandor.webp',                                     photoCredit: 'Eredeti fotó: nagybajom.hu' },
  'Barta-Eke Gyula': { photoUrl: '/images/persons/barta-eke-gyula-hvg.webp',                                photoCredit: 'Eredeti fotó: hvg.hu' },
  'Kis-Szölgyémi Ferenc': { photoUrl: '/images/persons/kis-szolgyemi-ferenc-ahang.webp',                    photoCredit: 'Eredeti fotó: ahang.hu' },
  'Tombor András':   { photoUrl: '/images/persons/tombor-andras-hvg.webp',                                 photoCredit: 'Eredeti fotó: hvg.hu' },
  'Hankó Balázs':    { photoUrl: '/images/persons/hanko-balazs.webp',                                      photoCredit: 'Eredeti fotó: kultura.hu' },
  'Bánki Erik':      { photoUrl: '/images/persons/banki-erik.webp',                                        photoCredit: 'Eredeti fotó: Telex', photoObjectPosition: 'right top' },
};
