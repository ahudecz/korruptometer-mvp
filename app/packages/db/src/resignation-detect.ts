        ...
        items: {
          ...
          properties: {
            ...
            description: {
              type: 'string',
              description:
                'Maximum 4-6 word Hungarian label for what happened — shown in a chart, must be very short, DE nyelvtanilag TELJES, természetes, egyértelmű mondat legyen (a "name" mezőben lévő személyre vonatkoztatva, akkor is, ha a nevet magát nem ismétled meg). NE hagyd el az igét vezénylő szerkezetet alany/vonzat nélkül úgy, hogy a pozíció-név álljon a mondat élén ("[pozíció]ról lemondott" — félreérthető, mintha a POZÍCIÓ mondott volna le). NE hagyd el az intézmény/kerület/szervezet kontextust sem, ha az szerepelt a cikkben — egy puszta "Lemondott alpolgármesterként" csonka, kontextus nélküli. Használj egyértelmű, TELJES "Lemondott [intézmény/kerület] X-ként" / "Kirúgták [intézmény]-ból/ből" / "Felmentették X alól" szerkezetet, az összes releváns kontextussal egy természetes szórendben. HELYES példák: "Lemondott XII. kerületi alpolgármesterként", "Lemondott az MCC kuratóriumi elnökeként", "Kirúgták a Kulturális Minisztériumból". HELYTELEN (ne ilyet írj): "XII. kerület alpolgármesterről lemondott" (pozíció az alany), "Lemondott alpolgármesterként" (hiányzik, melyik kerület/intézmény). KRITIKUS — EGYES SZÁMÚ TÁRGYAS IGE ALANY NÉLKÜL: a "Felmentette tisztségéből" (vagy "Kinevezte", "Leváltotta" stb.) EGYES SZÁM 3. személyű, TÁRGYAS igealak nyelvtanilag megköveteli, hogy ki legyen mondva, KI hajtotta végre a cselekvést ("Sulyok Tamás felmentette tisztségéből") — ha a cikkben nincs megnevezve a döntéshozó, ez a szerkezet befejezetlen, értelmetlen mondatot ad ("Felmentette tisztségéből" — ki?). Ha a döntéshozó ISMERT a cikkből, nevezd meg alanyként. Ha NEM ismert vagy nem releváns, használd a TÖBBES SZÁMÚ, alanytalan/általános alakot ("Felmentették tisztségéből", "Kinevezték", "Leváltották") — ez nyelvtanilag helyes magyar szerkezet konkrét alany nélkül is. HELYTELEN (ne ilyet írj): "Felmentette tisztségéből, de más megbízatást kapott" (hiányzó alany). HELYES: "Felmentették tisztségéből, de más megbízatást kapott" VAGY (ha ismert a döntéshozó) "Sulyok Tamás felmentette tisztségéből". HA a döntéshozó neve szerepel a mondatban, MINDIG ő álljon a mondat ELEJÉN, alanyként, a tárgyas ige ELŐTT — SOSE fordítva. HELYTELEN (valós hiba, félreérthető, mintha a MEGNEVEZETT SZEMÉLYT mentették volna fel): "Felmentette Magyar Péter, június 13-tól." (szórend miatt úgy olvasható, mintha Magyar Pétert mentették volna fel — pedig ő a döntéshozó). HELYES: "Magyar Péter felmentette tisztségéből, június 13-tól."',
            },
            sector: {
              type: 'string',
              enum: [
